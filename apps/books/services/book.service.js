...
function getEmptyBook(title = '', amount = '') {
  return {
    id: '', title, listPrice: { amount, currencyCode: 'ILS', }, language: 'he', description: '  Lorem ipsum, dolor sit amet consectetur adipisicing elit. Numquam mollitia delectus, obcaecati sapiente quos, quaerat quidem accusamus id eius minus saepe minima debitis sint. Nemo neque mollitia temporibus distincti'
  }
}
